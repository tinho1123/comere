        ...
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('Acréscimos por forma de pagamento')
                    ->description('Defina acréscimos aplicados ao valor do item conforme a forma de pagamento escolhida pelo cliente.')
                    ->collapsible()
                    ->collapsed()
                    ->schema([
                        Forms\Components\Grid::make(3)->schema([
                            ...
                            Forms\Components\Select::make('payment_surcharges.cash.type')
                                ->label('Tipo')
                                ->options(['percent' => 'Porcentagem (%)', 'fixed' => 'Valor fixo (R$)'])
                                ->default('percent')
                                ->native(false),
                            Forms\Components\TextInput::make('payment_surcharges.cash.amount')
                                ->label('Acréscimo')
                                ->numeric()->default(0)->minValue(0)->step(0.01),
                        ]),
                        Forms\Components\Grid::make(3)->schema([
